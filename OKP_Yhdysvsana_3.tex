...
COBOLin tyypityksest‰ on ristiriitaisia k‰sityksi‰. Wikipedian \cite{wikipediacobol} mukaan COBOL on vahvasti ja staattisesti tyypitetty kieli. Michael Coughlanin COBOL Tutorial \cite{cobolintro} kuitenkin v‰itt‰‰, ettei k‰‰nt‰j‰ tee tyyppitarkistuksia, ja COBOL olisi heikosti tyypitetty. Coughlanin mukaan esimerkiksi ei-numeerinen arvo on mahdollista sijoittaa numeerista tietoa sis‰lt‰v‰‰n muuttujaan. Kun v‰‰r‰‰ tietotyyppi‰ sis‰lt‰v‰ll‰ muuttujalla yritet‰‰n tehd‰ laskutoimituksia, COBOL-ohjelma kaatuu suorituksenaikaiseen virheeseen. 
