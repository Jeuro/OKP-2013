...
Yllä määriteltyä funktiota \verb+tervehdi+ kutsuttaessa vain yksi argumentti on  akollinen. Funktiokutsut erilaisilla argumenteilla tuottavat seuraavanlaisia tulostuksia:
...
Funktio voidaan määrittää myös siten, että sitä voidaan kutsua mielivaltaisilla parametreilla:
...
Suoritusaikaiseen virheeseen johtavia funktiokutsuja olisivat esimerkiksi kutsut \verb+tervehdi()+, \verb+tervehdi("Pekka", "Moi", tervehdys="Terve")+ sekä\\ \verb+tervehdi(tervehdys="Moi", "Pekka")+.
