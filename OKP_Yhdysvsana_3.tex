...
COBOLissa muuttujat ovat tyypiltään aakkosellisia (alphabetic), numeerisia (numeric), muokattu numeerinen (numeric-edited), aakkosnumeerinen (alphanumeric), kanji ja muokattu kanji (kanji-edited).
