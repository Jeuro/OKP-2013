...
Pythonissa k‰ytet‰‰n lis‰ki \textit{duck typing} -ohjelmointiparadigmaa \cite{ducktyping}. Olioiden tyyppi‰ t‰rke‰mp‰‰ ovat niiden ominaisuudet ja metodit. K‰yt‰nnˆss‰ t‰m‰ tarkoittaa sit‰, ett‰ metodien parametreina annettujen olioiden tyyppi‰ ei tarkisteta. Jos parametreina ollut olio ei toteuta funktion parametrilt‰ kutsuttavia metodeja, funktio signaloi suorituksenaikaisen virhetilanteen.
...
Esimerkiss‰ m‰‰ritell‰‰n kaksi luokkaa, \verb+Ankka+ ja \verb+Ihminen+ sek‰ funktio \verb+villi_luonto+. Funktio ei v‰lit‰ siit‰, onko sen parametrin tyyppin‰ \verb+Ankka+, vaan sit‰ voi kutsua myˆs luokan \verb+Ihminen+ ilmentym‰ll‰, sill‰ luokassa toteutetaan funktion vaatimat metodit. Javassa samantapainen k‰ytt‰ytyminen toteutettaisiin perinn‰n tai rajapintojen avulla.

Duck typingin lis‰ksi Pythonissa k‰ytet‰‰n tyyppip‰‰ttely‰ \cite{python2ref}. Tyyppip‰‰ttelyn s‰‰nnˆt vaihtelevat Pythonin versioissa suuresti, jonka vuoksi ohjelmointikielen referenssi ei anna tarkkaa tyyppip‰‰ttelys‰‰nnˆstˆ‰, vaan ainoastaan ep‰virallisia ohjenuoria. Pythonin versio 3 ei tue lainkaan tyyppip‰‰ttely‰.
