...
Muuttujaa \verb+muuttuja+ ei ole määritelty \verb+__init__+-metodin ulkopuolella. Muuttujia voidaan määritellä myös metodin ulkopuolella, mutta silloin ne ovat käytettävissä myös ilman luokan instanssia.
...
Itse asiassa luokkia tai niiden ilmentymiä ei ole mitenkään suojattu muutoksilta: niiden muuttujia ja metodeja voidaan korvata ja uusia lisätä täysin vapaasti. Jos esimerkiksi luokan \verb+Luokka+ \verb+__init__+-metodi ei miellytä, sen voi korvata vaikka seuraavasti:
