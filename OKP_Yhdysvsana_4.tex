...
COBOLin olio-ohjelmoinnin mahdollistava laajennus on monimutkaistaa COBOLin syntaksia entisest‰‰n. Lis‰ksi COBOLille tyypillisesti jo yksinkertaisten luokkien m‰‰ritteleminen tuottaa huomattavan paljon luettavaa koodia, jos vertailukohteena on esimerkiksi Javan tai varsinkin Pythonin tiivis ilmaisutapa.

Object-Oriented COBOLin toteutukset ovat monimuotoisia ja poikkeavat toisistaan ominaisuuksiltaan. On mahdollista kiistell‰, onko IBM:n toteutuksessa mahdollista k‰ytt‰‰ polymorfismia kovinkaan laajasti, sill‰ kielen referenssiss‰ ei ole lainkaan kuvailtu rajapintoja. Lis‰ksi muun muassa Micro Focus tukee COBOLin yhteistyˆt‰ C-kielen kanssa, kun taas IBM mahdollistaa Javan ja COBOLin yhdist‰misen. Yhteistyˆtuki eri kielten v‰lille muuttamat implementaatiota suuresti.
