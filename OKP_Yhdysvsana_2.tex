...
COBOL-85 esitteli sisäkkäiset ohjelmat ja \verb+GLOBAL+-lausekkeen.  COBOL-85:ssa ohjelman sisällä voi määritellä aliohjelmia. Oletusarvoisesti kunkin ohjelman muuttujat ovat käytettävissä ainoastaan kyseisen ohjelman sisällä, mutta jos muuttujan määrittelyssä on käytetty \verb+GLOBAL+-lauseketta, on se käytettävissä myös sisemmissä ohjelmissa. Jos useammassa sisäkkäisessä ohjelmassa on määritelty sama ''globaali'' muuttuja, näkyy sisimpiin ohjelmiin näihin nähden sisin määritelmä muuttujasta \cite[s. 439-441]{roy1989cobol}.
