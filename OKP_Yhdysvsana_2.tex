...
Seuraava esimerkki ohjelma tulostaa parittomat luvut väliltä [1, 10[:
\begin{samepage}
\begin{verbatim}
...
Pythonissa toisto voidaan toteuttaa myös käyttämällä rekursiota. Python ei kuitenkaan tue häntärekursion eliminointia \cite{pythontre}, minkä vuoksi häntärekursiota hyödyntäviä funktioita ei voi toteuttaa tehokkaasti.
